...
# Connect to the Shared Memory stream using GStreamer
# gst-launch-1.0 rtspsrc buffer-mode=0 do-retransmissions=0 drop-on-latency=1 latency=10 location=rtsp://127.0.0.1:8554/Pegasus_World_quadrotor_body_camera_LdrColor ! rtph265depay ! avdec_h265 ! videoconvert ! autovideosink sync=false
...
from pegasus.simulator.logic.sensors import Magnetometer, IMU, Barometer, GPS, Camera
from pegasus.simulator.logic.replicator import RepShmWriter
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        self.pg.world_settings["rendering_dt"] = 1.0 / FRAMERATE
        ...
        config_multirotor.sensors = [
            Magnetometer(), IMU(), Barometer(), GPS(),
        ...
        config_multirotor.replicator_writers = [
            RepShmWriter(camera_prim_path, shm_config)]
