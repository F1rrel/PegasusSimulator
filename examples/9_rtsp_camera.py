...
# Connect to the RTSP stream using GStreamer
...
from pegasus.simulator.logic.replicator import RepRTSPWriter
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        config_multirotor.replicator_writers = [
            RepRTSPWriter(camera_prim_path, {'topic': 'FrontCamera', 'bitrate': 2000.0, 'fps': 30.0, 'width': 2560, 'height': 2560})]
